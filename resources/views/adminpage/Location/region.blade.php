          ...
          <div class="row justify-content-center">
            <div class="col-12">
             ...
             <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#eventModal">
                <i class="bi bi-plus-circle-dotted"></i> Add Region
            </button>
              </div>
              <p class="card-text">List of Regions </p>
              <div class="row my-4">
                <!-- Small table -->
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <span class="badge
                                    {{ $region->status == 'active' ? 'bg-success text-white fs-1' : 'bg-danger text-white fs-1' }}">
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <form id="delete-form-{{ $region->id }}"
                                        action="{{ route('regiondelete', $region->id) }}"
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                   <div class="modal-header">
                    <h5 class="modal-title" id="eventModalLabel" >Add Region</h5>
                    ...
                    <form action="{{ route('storeregion') }}" method="POST" >
                         ...
                         <input type="text" class="form-control" name="name" placeholder=" Ee.g DAR ES SALAAM ..." >
                        </div>
