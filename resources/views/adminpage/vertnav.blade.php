          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="campany">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="{{ route('superadmin.comapny') }}"><span class="ml-1 item-text">Campany list</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="{{ route('superadmin.comapnyinfos') }}"><span class="ml-1 item-text">Campany infomations</span></a>
                </li>
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="profile">
                <a class="nav-link pl-3" href="{{ route('superadmin.users') }}"><span class="ml-1">Add New User</span></a>
